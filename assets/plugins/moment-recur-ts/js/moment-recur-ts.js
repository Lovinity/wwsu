...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.next = function (currentDateIn, limit) {
        ...
        if (!this.isLastDayOfPeriod(currentDate)) {
            var nextDateInPeriod = moment_1.default(currentDate).add(1, 'day');
    ...
    Calendar.prototype.previous = function (currentDateIn, limit) {
        ...
        if (!this.isFirstDayOfPeriod(currentDate)) {
            var nextDateInPeriod = moment_1.default(currentDate).subtract(1, 'day');
            if (this.match(nextDateInPeriod))
                return nextDateInPeriod;
        }
        while (true) {
        ...
        return units.map(function (unitIn) {
            ...
            if (typeof unitIn !== 'number') {
                ...
                if (_this.measure === 'daysOfWeek') {
                    ...
                    unitIn = moment_1.default().set('months', unitIn).get('months');
                }
                else {
                    unitIn = +unitIn;
                }
    ...
    Calendar.prototype.isLastDayOfPeriod = function (date) {
        if (this.measure === 'weeksOfMonthByDay') {
            return date.monthWeekByDay() !== moment_1.default(date).add(1, 'day').monthWeekByDay();
        }
        if (this.period === 'day') {
            return true;
        }
    ...
    Calendar.prototype.isFirstDayOfPeriod = function (date) {
        if (this.measure === 'weeksOfMonthByDay') {
            return date.monthWeekByDay() !== moment_1.default(date).subtract(1, 'day').monthWeekByDay();
        }
        if (this.period === 'day') {
            return true;
        }
...
var Recur = /** @class */ (function () {
    ...
    function Recur(options) {
        ...
        this.exceptions = exceptions.map(function (ex) { return moment_1.default(ex).dateOnly(); });
    ...
    Recur.prototype.addMeasureFunctions = function () {
        ...
        try {
            for (var _b = __values(Object.keys(rule_1.Rule.MeasureSingleToPlural)), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    Recur.prototype.isException = function (date) {
        var e_5, _a;
        try {
            for (var _b = __values(this.exceptions), _c = _b.next(); !_c.done; _c = _b.next()) {
...
moment_1.default.fn.dateOnly = function () {
    ...
    return this.isValid() ? moment_1.default.utc(this.format('YYYY-MM-DD')) : this;
};
