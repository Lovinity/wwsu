...
try {
  ...
  var darkskyWorker = new Worker('../../plugins/wwsu-display/workers/publicDarksky.js')
    ...
    fnStart: (slide) => {
      ...
      if (tcalendar.length > 0) {
        ...
        if (typeof tcalendar[ index ] !== 'undefined') {
          slide.displayTime = tcalendar[ index ].topic !== null ? 10 + Math.floor(tcalendar[ index ].topic.length / 20) : 10;
