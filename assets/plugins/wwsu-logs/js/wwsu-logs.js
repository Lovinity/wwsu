        ...
        this.tables.issues = $(`#section-notifications-issues-table`).DataTable(
          {
            ...
            drawCallback: () => {
              ...
              $(".btn-issue-dismiss").click((e) => {
                ...
                console.log(`dismiss`);
                util.confirmDialog(
                  `Are you sure you want to dismiss ${id}? <strong>This cannot be undone!</strong> Once you proceed, the issue will be dismissed from the todo window (but you can still find it in the logs). <strong>Please do not dismiss issues until they are resolved / no longer relevant.</strong>`,
                  null,
                  () => {
