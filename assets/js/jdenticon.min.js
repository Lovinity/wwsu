...
(function(q,y,z){var t=z(q,q.jQuery); 'undefined'!==typeof module&&'exports'in module?module.exports=t:'function'===typeof define&&define.amd?define([],() => {return t;}):q[y]=t;})(this,'jdenticon',(q,y) => {function z(a,b,c){for(var d=document.createElementNS('http://www.w3.org/2000/svg',b),f=2; f+1<arguments.length; f+=2){d.setAttribute(arguments[f],arguments[f+1]);}a.appendChild(d);}function t(a){this.b=Math.min(Number(a.getAttribute('width'))||100,Number(a.getAttribute('height'))||100); for(this.a=
...
e/4|0,c[d]=(c[d]||0)+(f[a+e]<<8*(3-(e&3)));}for(;16>++d;){c[d]=0;}return c;}var d=encodeURI(a); var f=[]; a=0; var e; var h=[]; for(e=0; e<d.length; e++){if('%'==d[e]){var k=r(d,e+1,2); e+=2;}else {k=d.charCodeAt(e);}f[a++]=k;}f[a++]=128; for(e=0; e+64<=a; e+=64){h.push(b(e,64));}d=a-e; e=b(e,d); 64<d+8&&(h.push(e),e=b(0,0)); e[15]=8*a-8; h.push(e); return h;}(a)));}function E(a,b){var c=a.canvas.width; var d=a.canvas.height; a.save(); this.b=a; b?this.a=b:(this.a=Math.min(c,d),a.translate((c-this.a)/2|0,(d-this.a)/2|0)); a.clearRect(0,0,this.a,
this.a);}function v(a){a|=0; return 0>a?'00':16>a?'0'+a.toString(16):256>a?a.toString(16):'ff';}function F(a,b,c){c=0>c?c+6:6<c?c-6:c; return v(255*(1>c?a+(b-a)*c:3>c?b:4>c?a+(b-a)*(4-c):a));}function O(a){'undefined'!==typeof MutationObserver&&(new MutationObserver(((b) => {for(var c=0; c<b.length; c++){for(var d=b[c],f=d.addedNodes,e=0; f&&e<f.length; e++){var h=f[e]; if(1==h.nodeType){if(g.w(h)){a(h);}else{h=h.querySelectorAll(g.A); for(var k=0; k<h.length; k++){a(h[k]);}}}}'attributes'==d.type&&g.w(d.target)&&
