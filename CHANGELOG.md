...
## [8.0.0] (ALPHA)
This release is a major re-coding of the calendar system and various other systems. It is NOT backwards-compatible with any versions prior. Documentation of changes is not available for this release due to the timeliness required to get this finished; please treat this varsion as you would a brand new library / application.

## [6.1.0 BETA] (Unreleased)
### Added
