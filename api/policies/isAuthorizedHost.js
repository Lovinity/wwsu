...
module.exports = async function (req, res, next) {
    ...
    if (req.headers && req.headers.authorization) {
        ...
        return res.status(401).json({err: 'This endpoint requires auth/host authorization.'});
    }
    ...
    try {
        ...
        sails.log.error(e);
        return res.status(401).json({err: 'This endpoint requires auth/host authorization. The provided token is invalid or expired.'});
    }
};
