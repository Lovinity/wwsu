  ...
  fn: async function (inputs, exits) {
    ...
    try {
      switch (inputs.task) {
        // Log an entry
        case 'log':
          await sails.models.logs.create({ attendanceID: sails.models.meta.memory.attendanceID, logtype: 'break', loglevel: 'info', logsubtype: 'automation', logIcon: `fas fa-coffee`, title: inputs.event, event: `` }).fetch()
            .tolerate(() => {
            })
          break
