...
module.exports = {
    ...
    fn: async function (inputs, exits) {
        ...
        try {
            ...
            var reference = await Discipline.create({active: true, IP: inputs.host, action: 'permaban', message: `The website user was banned indefinitely by ${Meta['A'].show}`}).fetch();
