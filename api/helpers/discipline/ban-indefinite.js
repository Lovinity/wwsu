module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      var reference = await sails.models.discipline.create({ active: true, IP: inputs.host, action: 'permaban', message: `The website user was banned indefinitely by ${sails.models.meta['A'].show}` }).fetch()
