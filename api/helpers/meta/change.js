    ...
    try {
      ...
      for (var key in inputs) {
        if (Object.prototype.hasOwnProperty.call(inputs, key)) {
          ...
          if (
            typeof sails.models.meta.memory[key] === "undefined" ||
          ...
          if (key === "state") {
            if (
              inputs[key] === "automation_on" ||
              inputs[key] === "automation_genre" ||
              inputs[key] === "automation_playlist" ||
              inputs[key] === "automation_prerecord"
            ) {
              push2.webchat = true;
            }
          }
          ...
          if (
            key === "listeners" &&
            inputs.listeners > sails.models.meta.memory.listenerPeak
          ) {
          ...
          if (
            ...
            if (
              (typeof inputs.playing !== "undefined" && !inputs.playing) ||
            ...
            if (
              inputs[key] === null &&
              sails.models.meta.memory[key] === null
            ) {
              continue;
            }
      ...
      if (
        typeof push.show !== "undefined" ||
        typeof push.state !== "undefined" ||
        typeof push.playlist !== "undefined" ||
        typeof push.genre !== "undefined" ||
        typeof push.trackArtist !== "undefined" ||
        typeof push.trackTitle !== "undefined" ||
        typeof push.trackID !== "undefined"
      ) {
        ...
        if (sails.models.meta.memory.trackID !== 0) {
          ...
          if (typeof push.trackID !== "undefined") {
            if (
              _.includes(
                sails.models.requests.pending,
                sails.models.meta.memory.trackID
              )
            ) {
              var requested = await sails.models.requests
                .update(
                  { songID: sails.models.meta.memory.trackID, played: 0 },
                  { played: 1 }
                )
                .fetch()
                .tolerate(() => {});
              delete sails.models.requests.pending[
                sails.models.requests.pending.indexOf(
                  sails.models.meta.memory.trackID
                )
              ];
          ...
          if (typeof push.trackID !== "undefined") {
            ...
            await sails.models.logs
              .create({
                ...
                title: `A track played in RadioDJ.`,
                event: `${
                  push2.requested
                    ? `Requested by: ${push2.requestedBy || `Unknown User`}`
                    : ``
                }`,
            ...
            if (
              ...
              push2.history.unshift({
                ID: sails.models.meta.memory.trackID,
                track:
                  (sails.models.meta.memory.trackArtist || "Unknown Artist") +
                  " - " +
                  (sails.models.meta.memory.trackTitle || "Unknown Title"),
          ...
          if (typeof push.trackID !== "undefined" && push.trackID === 0) {
            ...
            manual =
              sails.models.meta.memory.trackArtist !== null &&
              sails.models.meta.memory.trackArtist !== "" &&
              sails.models.meta.memory.trackTitle !== null &&
              sails.models.meta.memory.trackTitle !== "";
          }
          ...
          if (sails.models.meta.memory.state.startsWith("live_")) {
            ...
            push2.line2 = ``;
            push2.stream = await sails.helpers.filterProfane(
              `${sails.models.meta.memory.show} (PRERECORD)`
            );
        ...
        if (push2.requested && typeof requested[0] !== `undefined`) {
          var subscriptions = await sails.models.subscribers
          ...
          if (devices.length > 0) {
            await sails.helpers.onesignal.send(
              devices,
              `request`,
              `Your Request is Playing!`,
              (await sails.helpers.filterProfane(
                `${sails.models.meta.memory.trackArtist} - ${sails.models.meta.memory.trackTitle}`
              )) + ` is now playing on WWSU!`,
              60 * 15
            );
          }
        }
      ...
      for (var key3 in push) {
        if (Object.prototype.hasOwnProperty.call(push, key3)) {
          try {
            if (key3 in sails.models.meta.attributes) {
              db[key3] = push[key3];
            }
          } catch (e) {
