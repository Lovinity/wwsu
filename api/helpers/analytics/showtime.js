module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    var process1 = async () => {
      var records = await sails.models.xp.find({ dj: inputs.djs ? inputs.djs : { '!=': null } })
      records.map((record) => {
    ...
    var process3 = async () => {
      ...
      records2
        .filter((record) => ((inputs.djs && inputs.djs.length > 0 && (inputs.djs.indexOf(record.dj) !== -1 || inputs.djs.indexOf(record.cohostDJ1) !== -1 || inputs.djs.indexOf(record.cohostDJ2) !== -1 || inputs.djs.indexOf(record.cohostDJ3) !== -1)) || ((!inputs.djs || inputs.djs.length === 0) && (record.dj || record.cohostDJ1 || record.cohostDJ2 || record.cohostDJ3))))
        .map((record) => {
