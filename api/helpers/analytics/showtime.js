      ...
      var process1_2 = (record) => {
        ...
        if (record.dj && typeof DJs[record.dj] !== "undefined") {
          if (record.type.startsWith("remote-")) {
            ...
            if (moment().subtract(7, "days").isBefore(moment(record.date))) {
    ...
    var process2 = new Promise(async (resolve) => {
      ...
      var process2_2 = (record) => {
        ["dj", "cohostDJ1", "cohostDJ2", "cohostDJ3"].map((dj) => {
          ...
          if (
            ...
            if (record.listenerPeak > DJs[record[dj]].overall.listenerPeak) {
              ...
              DJs[record[dj]].overall.listenerPeakTime =
                record.listenerPeakTime;
            }
            if (
              moment(sails.config.custom.startOfSemester).isBefore(
              ...
              if (record.listenerPeak > DJs[record[dj]].semester.listenerPeak) {
                ...
                DJs[record[dj]].semester.listenerPeakTime =
                  record.listenerPeakTime;
              }
            }
            if (
              moment().subtract(7, "days").isBefore(moment(record.createdAt))
            ) {
            ...
            if (
              ...
              if (record.listenerPeak > DJs[record[dj]].range.listenerPeak) {
                ...
                DJs[record[dj]].range.listenerPeakTime =
                  record.listenerPeakTime;
              }
            }
          }
        ...
        if (
          ...
          if (
            record.listenerPeak > shows[record.calendarID].overall.listenerPeak
          ) {
            shows[record.calendarID].overall.listenerPeak = record.listenerPeak;
            shows[record.calendarID].overall.listenerPeakTime =
              record.listenerPeakTime;
          }
          if (
            moment(sails.config.custom.startOfSemester).isBefore(
            ...
            if (
              record.listenerPeak >
              shows[record.calendarID].semester.listenerPeak
            ) {
              shows[record.calendarID].semester.listenerPeak =
                record.listenerPeak;
              shows[record.calendarID].semester.listenerPeakTime =
                record.listenerPeakTime;
            }
          }
          if (moment().subtract(7, "days").isBefore(moment(record.createdAt))) {
            ...
            if (
              record.listenerPeak > shows[record.calendarID].week.listenerPeak
            ) {
              shows[record.calendarID].week.listenerPeak = record.listenerPeak;
              shows[record.calendarID].week.listenerPeakTime =
                record.listenerPeakTime;
            }
          }
          if (
            ...
            if (
              record.listenerPeak > shows[record.calendarID].range.listenerPeak
            ) {
              shows[record.calendarID].range.listenerPeak = record.listenerPeak;
              shows[record.calendarID].range.listenerPeakTime =
                record.listenerPeakTime;
            }
          }
        }
    ...
    var process4 = new Promise(async (resolve) => {
      ...
      var process4_2 = (record) => {
        ...
        if (record.cancellation) {
          ...
          if (
            moment().subtract(7, "days").isBefore(moment(record.scheduledStart))
          ) {
        ...
        if (record.signedOnEarly) {
          ["dj", "cohostDJ1", "cohostDJ2", "cohostDJ3"].map((dj) => {
            ...
            if (
              moment().subtract(7, "days").isBefore(moment(record.actualStart))
            ) {
              DJs[record[dj]].week.reputationScore -= 2;
