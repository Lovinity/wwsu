...
module.exports = {
  ...
  fn: async function (inputs) {
    ...
    // Initialize range
    var start = inputs.start ? moment(inputs.start).toISOString(true) : moment("2002-01-01T00:00:00Z").toISOString(true);
    var end = inputs.end ? moment(inputs.end).toISOString(true) : moment().toISOString(true);
    ...
    var process1 = new Promise(async (resolve) => {
      let records = await sails.models.xp.find({ dj: inputs.djs ? inputs.djs : { '!=': null } });
    ...
    var process2 = new Promise(async (resolve) => {
      let records = records2.filter(record => record.showTime !== null && record.listenerMinutes !== null);
      ...
      var process2_2 = (record) => {
        [ 'dj', 'cohostDJ1', 'cohostDJ2', 'cohostDJ3' ].map((dj) => {
          ...
          if (!record.event.toLowerCase().startsWith("sports: ") && !record.event.toLowerCase().startsWith("genre: ")) {
        ...
        if (record.event.toLowerCase().startsWith("show: ") || record.event.toLowerCase().startsWith("remote: ") || record.event.toLowerCase().startsWith("prerecord: ")) {
    ...
    var process3 = new Promise(async (resolve) => {
      ...
      let records = records2.filter((record) => ((inputs.djs && inputs.djs.length > 0 && (inputs.djs.indexOf(record.dj) !== -1 || inputs.djs.indexOf(record.cohostDJ1) !== -1 || inputs.djs.indexOf(record.cohostDJ2) !== -1 || inputs.djs.indexOf(record.cohostDJ3) !== -1)) || ((!inputs.djs || inputs.djs.length === 0) && (record.dj || record.cohostDJ1 || record.cohostDJ2 || record.cohostDJ3))))
      ...
      await new Promise(async (resolve2) => {
        var process3_3 = (record) => {
          ...
          console.dir(typeof record.createdAt);
            ...
            if (record.event.toLowerCase().startsWith('show: ')) {
              ...
              if (moment(record.createdAt).isSameOrAfter(moment(start)) && moment(record.createdAt).isBefore(moment(end))) {
                ...
                if (record.scheduledStart !== null && record.scheduledEnd !== null) {
                  ...
                  initializeShow(record.calendarID);
                  if (record.calendarID && typeof shows[ record.calendarID ] !== 'undefined') shows[ record.calendarID ].range.reputationScoreMax += (5 + breakPoints);
                }
              }
              ...
              if (moment(record.createdAt).isSameOrAfter(moment(start)) && moment(record.createdAt).isBefore(moment(end))) {
                ...
                if (record.calendarID && typeof shows[ record.calendarID ] !== 'undefined') {
                  ...
                  shows[ record.calendarID ].range.reputationScoreMax += (2 + breakPoints)
                  shows[ record.calendarID ].range.breaks += record.breaks;
                }
              }
              ...
              if (record.calendarID && typeof shows[ record.calendarID ] !== 'undefined') {
                ...
                shows[ record.calendarID ].overall.breaks += record.breaks;
                shows[ record.calendarID ].overall.reputationScoreMax += (1 + breakPoints)
              }
              if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.createdAt))) {
                ...
                if (record.calendarID && typeof shows[ record.calendarID ] !== 'undefined') {
                  ...
                  shows[ record.calendarID ].semester.breaks += record.breaks;
                  shows[ record.calendarID ].semester.reputationScoreMax += (1 + breakPoints)
                }
              }
              if (moment().subtract(7, 'days').isBefore(moment(record.createdAt))) {
                ...
                if (record.calendarID && typeof shows[ record.calendarID ] !== 'undefined') {
                  ...
                  shows[ record.calendarID ].week.breaks += record.breaks;
                  shows[ record.calendarID ].week.reputationScoreMax += (1 + breakPoints)
                }
              }
              if (moment(record.createdAt).isSameOrAfter(moment(start)) && moment(record.createdAt).isBefore(moment(end))) {
                ...
                if (record.calendarID && typeof shows[ record.calendarID ] !== 'undefined') {
                  ...
                  shows[ record.calendarID ].range.breaks += record.breaks;
                  shows[ record.calendarID ].range.reputationScoreMax += (1 + breakPoints)
                }
              }
    ...
    var process4 = new Promise(async (resolve) => {
      ...
      var process4_2 = (record) => {
        ...
        if (record.cancellation) {
          [ 'dj', 'cohostDJ1', 'cohostDJ2', 'cohostDJ3' ].map((dj) => {
            initializeDJ(record[ dj ]);
            if (!record[ dj ] || typeof DJs[ record[ dj ] ] === 'undefined' || record.event.toLowerCase().startsWith('genre: ') || record.event.toLowerCase().startsWith('sports: ')) return;
            DJs[ record[ dj ] ].overall.reputationScore -= 1;
            DJs[ record[ dj ] ].overall.cancellations += 1;
            DJs[ record[ dj ] ].overall.cancellationsArray.push([ record.event, record.scheduledStart ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.scheduledStart))) {
              DJs[ record[ dj ] ].semester.reputationScore -= 1;
              DJs[ record[ dj ] ].semester.cancellations += 1;
              DJs[ record[ dj ] ].semester.cancellationsArray.push([ record.event, record.scheduledStart ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.scheduledStart))) {
              DJs[ record[ dj ] ].week.reputationScore -= 1;
              DJs[ record[ dj ] ].week.cancellations += 1;
              DJs[ record[ dj ] ].week.cancellationsArray.push([ record.event, record.scheduledStart ]);
            }
            if (moment(record.scheduledStart).isSameOrAfter(moment(start)) && moment(record.scheduledStart).isBefore(moment(end))) {
              DJs[ record[ dj ] ].range.reputationScore -= 1;
              DJs[ record[ dj ] ].range.cancellations += 1;
              DJs[ record[ dj ] ].range.cancellationsArray.push([ record.event, record.scheduledStart ]);
            }
          });
          ...
          if (record.calendarID && typeof shows[ record.calendarID ] !== 'undefined') {
            ...
            shows[ record.calendarID ].overall.cancellationsArray.push([ record.event, record.scheduledStart ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.scheduledStart))) {
              shows[ record.calendarID ].semester.reputationScore -= 1;
              shows[ record.calendarID ].semester.cancellations += 1;
              shows[ record.calendarID ].semester.cancellationsArray.push([ record.event, record.scheduledStart ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.scheduledStart))) {
              shows[ record.calendarID ].week.reputationScore -= 1;
              shows[ record.calendarID ].week.cancellations += 1;
              shows[ record.calendarID ].week.cancellationsArray.push([ record.event, record.scheduledStart ]);
            }
            if (moment(record.scheduledStart).isSameOrAfter(moment(start)) && moment(record.scheduledStart).isBefore(moment(end))) {
              shows[ record.calendarID ].range.reputationScore -= 1;
              shows[ record.calendarID ].range.cancellations += 1;
              shows[ record.calendarID ].range.cancellationsArray.push([ record.event, record.scheduledStart ]);
            }
          }
        }
        ...
        if (record.silence && record.silence.length > 0) {
          [ 'dj', 'cohostDJ1', 'cohostDJ2', 'cohostDJ3' ].map((dj) => {
            ...
            DJs[ record[ dj ] ].overall.silencesArray.push([ record.event, record.silence ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.scheduledStart || record.actualStart || record.createdAt))) {
              DJs[ record[ dj ] ].semester.reputationScore -= record.silence.length;
              DJs[ record[ dj ] ].semester.silences += record.silence.length;
              DJs[ record[ dj ] ].semester.silencesArray.push([ record.event, record.silence ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.scheduledStart || record.actualStart || record.createdAt))) {
              DJs[ record[ dj ] ].week.reputationScore -= record.silence.length;
              DJs[ record[ dj ] ].week.silences += record.silence.length;
              DJs[ record[ dj ] ].week.silencesArray.push([ record.event, record.silence ]);
            }
            if (moment(record.scheduledStart || record.actualStart || record.createdAt).isSameOrAfter(moment(start)) && moment(record.scheduledStart || record.actualStart || record.createdAt).isBefore(moment(end))) {
              DJs[ record[ dj ] ].range.reputationScore -= record.silence.length;
              DJs[ record[ dj ] ].range.silences += record.silence.length;
              DJs[ record[ dj ] ].range.silencesArray.push([ record.event, record.silence ]);
            }
          });
          ...
          initializeShow(record.calendarID);
          if (record.calendarID && typeof shows[ record.calendarID ] !== 'undefined') {
            shows[ record.calendarID ].overall.reputationScore -= record.silence.length;
            shows[ record.calendarID ].overall.silences += record.silence.length;
            shows[ record.calendarID ].overall.silencesArray.push([ record.event, record.silence ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.scheduledStart || record.actualStart || record.createdAt))) {
              shows[ record.calendarID ].semester.reputationScore -= record.silence.length;
              shows[ record.calendarID ].semester.silences += record.silence.length;
              shows[ record.calendarID ].semester.silencesArray.push([ record.event, record.silence ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.scheduledStart || record.actualStart || record.createdAt))) {
              shows[ record.calendarID ].week.reputationScore -= record.silence.length;
              shows[ record.calendarID ].week.silences += record.silence.length;
              shows[ record.calendarID ].week.silencesArray.push([ record.event, record.silence ]);
            }
            if (moment(record.scheduledStart || record.actualStart || record.createdAt).isSameOrAfter(moment(start)) && moment(record.scheduledStart || record.actualStart || record.createdAt).isBefore(moment(end))) {
              shows[ record.calendarID ].range.reputationScore -= record.silence.length;
              shows[ record.calendarID ].range.silences += record.silence.length;
              shows[ record.calendarID ].range.silencesArray.push([ record.event, record.silence ]);
            }
          }
        }
        ...
        if (record.absent) {
          [ 'dj', 'cohostDJ1', 'cohostDJ2', 'cohostDJ3' ].map((dj) => {
            ...
            DJs[ record[ dj ] ].overall.absencesArray.push([ record.event, record.scheduledStart ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.scheduledStart))) {
              DJs[ record[ dj ] ].semester.reputationScore -= 3;
              DJs[ record[ dj ] ].semester.absences += 1;
              DJs[ record[ dj ] ].semester.absencesArray.push([ record.event, record.scheduledStart ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.scheduledStart))) {
              DJs[ record[ dj ] ].week.reputationScore -= 3;
              DJs[ record[ dj ] ].week.absences += 1;
              DJs[ record[ dj ] ].week.absencesArray.push([ record.event, record.scheduledStart ]);
            }
            if (moment(record.scheduledStart).isSameOrAfter(moment(start)) && moment(record.scheduledStart).isBefore(moment(end))) {
              DJs[ record[ dj ] ].range.reputationScore -= 3;
              DJs[ record[ dj ] ].range.absences += 1;
              DJs[ record[ dj ] ].range.absencesArray.push([ record.event, record.scheduledStart ]);
            }
          });
          ...
          if (record.calendarID && typeof shows[ record.calendarID ] !== 'undefined') {
            ...
            shows[ record.calendarID ].overall.absencesArray.push([ record.event, record.scheduledStart ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.scheduledStart))) {
              shows[ record.calendarID ].semester.reputationScore -= 3;
              shows[ record.calendarID ].semester.absences += 1;
              shows[ record.calendarID ].semester.absencesArray.push([ record.event, record.scheduledStart ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.scheduledStart))) {
              shows[ record.calendarID ].week.reputationScore -= 3;
              shows[ record.calendarID ].week.absences += 1;
              shows[ record.calendarID ].week.absencesArray.push([ record.event, record.scheduledStart ]);
            }
            if (moment(record.scheduledStart).isSameOrAfter(moment(start)) && moment(record.scheduledStart).isBefore(moment(end))) {
              shows[ record.calendarID ].range.reputationScore -= 3;
              shows[ record.calendarID ].range.absences += 1;
              shows[ record.calendarID ].range.absencesArray.push([ record.event, record.scheduledStart ]);
            }
          }
        }
        ...
        if (record.unauthorized) {
          [ 'dj', 'cohostDJ1', 'cohostDJ2', 'cohostDJ3' ].map((dj) => {
            ...
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.actualStart || record.createdAt))) {
              DJs[ record[ dj ] ].semester.reputationScore -= 2;
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.actualStart || record.createdAt))) {
              DJs[ record[ dj ] ].week.reputationScore -= 2;
            }
            if (moment(record.actualStart || record.createdAt).isSameOrAfter(moment(start)) && moment(record.actualStart || record.createdAt).isBefore(moment(end))) {
        ...
        if (record.missedIDs && record.missedIDs.length > 0) {
          [ 'dj', 'cohostDJ1', 'cohostDJ2', 'cohostDJ3' ].map((dj) => {
            initializeDJ(record[ dj ]);
            if (!record[ dj ] || typeof DJs[ record[ dj ] ] === 'undefined' || record.event.toLowerCase().startsWith('genre: ') || record.event.toLowerCase().startsWith('sports: ')) return;
            DJs[ record[ dj ] ].overall.reputationScore -= (3 * record.missedIDs.length);
            DJs[ record[ dj ] ].overall.missedIDs += record.missedIDs.length;
            DJs[ record[ dj ] ].overall.missedIDsArray.push([ record.event, record.missedIDs ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.createdAt))) {
              DJs[ record[ dj ] ].semester.reputationScore -= (3 * record.missedIDs.length);
              DJs[ record[ dj ] ].semester.missedIDs += record.missedIDs.length;
              DJs[ record[ dj ] ].semester.missedIDsArray.push([ record.event, record.missedIDs ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.createdAt))) {
              DJs[ record[ dj ] ].week.reputationScore -= (3 * record.missedIDs.length);
              DJs[ record[ dj ] ].week.missedIDs += record.missedIDs.length;
              DJs[ record[ dj ] ].week.missedIDsArray.push([ record.event, record.missedIDs ]);
            }
            if (moment(record.createdAt).isSameOrAfter(moment(start)) && moment(record.createdAt).isBefore(moment(end))) {
              DJs[ record[ dj ] ].range.reputationScore -= (3 * record.missedIDs.length);
              DJs[ record[ dj ] ].range.missedIDs += record.missedIDs.length;
              DJs[ record[ dj ] ].range.missedIDsArray.push([ record.event, record.missedIDs ]);
            }
          });
          ...
          initializeShow(record.calendarID);
          if (record.calendarID && typeof shows[ record.calendarID ] !== 'undefined') {
            shows[ record.calendarID ].overall.reputationScore -= (3 * record.missedIDs.length);
            shows[ record.calendarID ].overall.missedIDs += record.missedIDs.length;
            shows[ record.calendarID ].overall.missedIDsArray.push([ record.event, record.missedIDs ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.createdAt))) {
              shows[ record.calendarID ].semester.reputationScore -= (3 * record.missedIDs.length);
              shows[ record.calendarID ].semester.missedIDs += record.missedIDs.length;
              shows[ record.calendarID ].semester.missedIDsArray.push([ record.event, record.missedIDs ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.createdAt))) {
              shows[ record.calendarID ].week.reputationScore -= (3 * record.missedIDs.length);
              shows[ record.calendarID ].week.missedIDs += record.missedIDs.length;
              shows[ record.calendarID ].week.missedIDsArray.push([ record.event, record.missedIDs ]);
            }
            if (moment(record.createdAt).isSameOrAfter(moment(start)) && moment(record.createdAt).isBefore(moment(end))) {
              shows[ record.calendarID ].range.reputationScore -= (3 * record.missedIDs.length);
              shows[ record.calendarID ].range.missedIDs += record.missedIDs.length;
              shows[ record.calendarID ].range.missedIDsArray.push([ record.event, record.missedIDs ]);
            }
          }
        }
        ...
        if (record.signedOnEarly) {
          [ 'dj', 'cohostDJ1', 'cohostDJ2', 'cohostDJ3' ].map((dj) => {
            ...
            DJs[ record[ dj ] ].overall.earlyStartArray.push([ record.event, record.actualStart ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.actualStart))) {
              DJs[ record[ dj ] ].semester.reputationScore -= 2;
              DJs[ record[ dj ] ].semester.earlyStart += 1;
              DJs[ record[ dj ] ].semester.earlyStartArray.push([ record.event, record.actualStart ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.actualStart))) {
              DJs[ record[ dj ] ].week.reputationScore -= 2;
              DJs[ record[ dj ] ].week.earlyStart += 1;
              DJs[ record[ dj ] ].week.earlyStartArray.push([ record.event, record.actualStart ]);
            }
            if (moment(record.actualStart).isSameOrAfter(moment(start)) && moment(record.actualStart).isBefore(moment(end))) {
              DJs[ record[ dj ] ].range.reputationScore -= 2;
              DJs[ record[ dj ] ].range.earlyStart += 1;
              DJs[ record[ dj ] ].range.earlyStartArray.push([ record.event, record.actualStart ]);
            }
          });
          shows[ 0 ].overall.reputationScore -= 2;
          ...
          if (record.calendarID && typeof shows[ record.calendarID ] !== 'undefined') {
            ...
            shows[ record.calendarID ].overall.earlyStartArray.push([ record.event, record.actualStart ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.actualStart))) {
              shows[ record.calendarID ].semester.reputationScore -= 2;
              shows[ record.calendarID ].semester.earlyStart += 1;
              shows[ record.calendarID ].semester.earlyStartArray.push([ record.event, record.actualStart ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.actualStart))) {
              shows[ record.calendarID ].week.reputationScore -= 2;
              shows[ record.calendarID ].week.earlyStart += 1;
              shows[ record.calendarID ].week.earlyStartArray.push([ record.event, record.actualStart ]);
            }
            if (moment(record.actualStart).isSameOrAfter(moment(start)) && moment(record.actualStart).isBefore(moment(end))) {
              shows[ record.calendarID ].range.reputationScore -= 2;
              shows[ record.calendarID ].range.earlyStart += 1;
              shows[ record.calendarID ].range.earlyStartArray.push([ record.event, record.actualStart ]);
            }
          }
        }
        ...
        if (record.signedOffLate) {
          [ 'dj', 'cohostDJ1', 'cohostDJ2', 'cohostDJ3' ].map((dj) => {
            ...
            DJs[ record[ dj ] ].overall.lateEndArray.push([ record.event, record.actualEnd ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.actualStart))) {
              DJs[ record[ dj ] ].semester.reputationScore -= 2;
              DJs[ record[ dj ] ].semester.lateEnd += 1;
              DJs[ record[ dj ] ].semester.lateEndArray.push([ record.event, record.actualEnd ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.actualStart))) {
              DJs[ record[ dj ] ].week.reputationScore -= 2;
              DJs[ record[ dj ] ].week.lateEnd += 1;
              DJs[ record[ dj ] ].week.lateEndArray.push([ record.event, record.actualEnd ]);
            }
            if (moment(record.actualStart).isSameOrAfter(moment(start)) && moment(record.actualStart).isBefore(moment(end))) {
              DJs[ record[ dj ] ].range.reputationScore -= 2;
              DJs[ record[ dj ] ].range.lateEnd += 1;
              DJs[ record[ dj ] ].range.lateEndArray.push([ record.event, record.actualEnd ]);
            }
          });
          shows[ 0 ].overall.reputationScore -= 2;
          ...
          if (record.calendarID && typeof shows[ record.calendarID ] !== 'undefined') {
            ...
            shows[ record.calendarID ].overall.lateEndArray.push([ record.event, record.actualEnd ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.actualStart))) {
              shows[ record.calendarID ].semester.reputationScore -= 2;
              shows[ record.calendarID ].semester.lateEnd += 1;
              shows[ record.calendarID ].semester.lateEndArray.push([ record.event, record.actualEnd ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.actualStart))) {
              shows[ record.calendarID ].week.reputationScore -= 2;
              shows[ record.calendarID ].week.lateEnd += 1;
              shows[ record.calendarID ].week.lateEndArray.push([ record.event, record.actualEnd ]);
            }
            if (moment(record.createdAt).isSameOrAfter(moment(start)) && moment(record.createdAt).isBefore(moment(end))) {
              shows[ record.calendarID ].range.reputationScore -= 2;
              shows[ record.calendarID ].range.lateEnd += 1;
              shows[ record.calendarID ].range.lateEndArray.push([ record.event, record.actualEnd ]);
            }
          }
        }
        ...
        if (record.signedOnLate) {
          [ 'dj', 'cohostDJ1', 'cohostDJ2', 'cohostDJ3' ].map((dj) => {
            ...
            DJs[ record[ dj ] ].overall.lateStartArray.push([ record.event, record.actualStart ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.actualStart))) {
              DJs[ record[ dj ] ].semester.reputationScore -= 1;
              DJs[ record[ dj ] ].semester.lateStart += 1;
              DJs[ record[ dj ] ].semester.lateStartArray.push([ record.event, record.actualStart ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.actualStart))) {
              DJs[ record[ dj ] ].week.reputationScore -= 1;
              DJs[ record[ dj ] ].week.lateStart += 1;
              DJs[ record[ dj ] ].week.lateStartArray.push([ record.event, record.actualStart ]);
            }
            if (moment(record.actualStart).isSameOrAfter(moment(start)) && moment(record.actualStart).isBefore(moment(end))) {
              DJs[ record[ dj ] ].range.reputationScore -= 1;
              DJs[ record[ dj ] ].range.lateStart += 1;
              DJs[ record[ dj ] ].range.lateStartArray.push([ record.event, record.actualStart ]);
            }
          });
          shows[ 0 ].overall.reputationScore -= 1;
          ...
          if (record.calendarID && typeof shows[ record.calendarID ] !== 'undefined') {
            ...
            shows[ record.calendarID ].overall.lateStartArray.push([ record.event, record.actualStart ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.actualStart))) {
              shows[ record.calendarID ].semester.reputationScore -= 1;
              shows[ record.calendarID ].semester.lateStart += 1;
              shows[ record.calendarID ].semester.lateStartArray.push([ record.event, record.actualStart ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.actualStart))) {
              shows[ record.calendarID ].week.reputationScore -= 1;
              shows[ record.calendarID ].week.lateStart += 1;
              shows[ record.calendarID ].week.lateStartArray.push([ record.event, record.actualStart ]);
            }
            if (moment(record.actualStart).isSameOrAfter(moment(start)) && moment(record.actualStart).isBefore(moment(end))) {
              shows[ record.calendarID ].range.reputationScore -= 1;
              shows[ record.calendarID ].range.lateStart += 1;
              shows[ record.calendarID ].range.lateStartArray.push([ record.event, record.actualStart ]);
            }
          }
        }
        ...
        if (record.signedOffEarly) {
          [ 'dj', 'cohostDJ1', 'cohostDJ2', 'cohostDJ3' ].map((dj) => {
            ...
            DJs[ record[ dj ] ].overall.earlyEndArray.push([ record.event, record.actualEnd ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.actualStart))) {
              DJs[ record[ dj ] ].semester.reputationScore -= 1;
              DJs[ record[ dj ] ].semester.earlyEnd += 1;
              DJs[ record[ dj ] ].semester.earlyEndArray.push([ record.event, record.actualEnd ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.actualStart))) {
              DJs[ record[ dj ] ].week.reputationScore -= 1;
              DJs[ record[ dj ] ].week.earlyEnd += 1;
              DJs[ record[ dj ] ].week.earlyEndArray.push([ record.event, record.actualEnd ]);
            }
            if (moment(record.actualStart).isSameOrAfter(moment(start)) && moment(record.actualStart).isBefore(moment(end))) {
              DJs[ record[ dj ] ].range.reputationScore -= 1;
              DJs[ record[ dj ] ].range.earlyEnd += 1;
              DJs[ record[ dj ] ].range.earlyEndArray.push([ record.event, record.actualEnd ]);
            }
          });
          shows[ 0 ].overall.reputationScore -= 1;
          ...
          if (record.calendarID && typeof shows[ record.calendarID ] !== 'undefined') {
            ...
            shows[ record.calendarID ].overall.earlyEndArray.push([ record.event, record.actualEnd ]);
            if (moment(sails.config.custom.startOfSemester).isBefore(moment(record.actualStart))) {
              shows[ record.calendarID ].semester.reputationScore -= 1;
              shows[ record.calendarID ].semester.earlyEnd += 1;
              shows[ record.calendarID ].semester.earlyEndArray.push([ record.event, record.actualEnd ]);
            }
            if (moment().subtract(7, 'days').isBefore(moment(record.actualStart))) {
              shows[ record.calendarID ].week.reputationScore -= 1;
              shows[ record.calendarID ].week.earlyEnd += 1;
              shows[ record.calendarID ].week.earlyEndArray.push([ record.event, record.actualEnd ]);
            }
            if (moment(record.actualStart).isSameOrAfter(moment(start)) && moment(record.actualStart).isBefore(moment(end))) {
              shows[ record.calendarID ].range.reputationScore -= 1;
              shows[ record.calendarID ].range.earlyEnd += 1;
              shows[ record.calendarID ].range.earlyEndArray.push([ record.event, record.actualEnd ]);
            }
          }
        }
    ...
    for (var index in DJs) {
      if (Object.prototype.hasOwnProperty.call(DJs, index)) {
        ...
        DJs[ index ].overall.ratio = DJs[ index ].overall.showtime > 0 ? DJs[ index ].overall.listeners / DJs[ index ].overall.showtime : 0
        DJs[ index ].semester.ratio = DJs[ index ].semester.showtime > 0 ? DJs[ index ].semester.listeners / DJs[ index ].semester.showtime : 0
        DJs[ index ].week.ratio = DJs[ index ].week.showtime > 0 ? DJs[ index ].week.listeners / DJs[ index ].week.showtime : 0
        DJs[ index ].range.ratio = DJs[ index ].range.showtime > 0 ? DJs[ index ].range.listeners / DJs[ index ].range.showtime : 0

        // Calculate the reputation percent
        DJs[ index ].overall.reputationScore += DJs[ index ].overall.reputationScoreMax;
        DJs[ index ].overall.reputationPercent = DJs[ index ].overall.reputationScore > 0 ? Math.round(100 * (DJs[ index ].overall.reputationScore / DJs[ index ].overall.reputationScoreMax)) : 0;
        DJs[ index ].semester.reputationScore += DJs[ index ].semester.reputationScoreMax;
        DJs[ index ].semester.reputationPercent = DJs[ index ].semester.reputationScore > 0 ? Math.round(100 * (DJs[ index ].semester.reputationScore / DJs[ index ].semester.reputationScoreMax)) : 0;
        DJs[ index ].week.reputationScore += DJs[ index ].week.reputationScoreMax;
        DJs[ index ].week.reputationPercent = DJs[ index ].week.reputationScore > 0 ? Math.round(100 * (DJs[ index ].week.reputationScore / DJs[ index ].week.reputationScoreMax)) : 0;
        DJs[ index ].range.reputationScore += DJs[ index ].range.reputationScoreMax;
        DJs[ index ].range.reputationPercent = DJs[ index ].range.reputationScore > 0 ? Math.round(100 * (DJs[ index ].range.reputationScore / DJs[ index ].range.reputationScoreMax)) : 0;

        // Get DJ name
        if (index > 0) {
          let name = await sails.models.djs.findOne({ ID: index });
          if (name) {
            DJs[ index ].name = `${name.name} (${name.realName || `Unknown Person`})`;
          } else {
    ...
    for (var index in shows) {
      if (Object.prototype.hasOwnProperty.call(shows, index)) {
        // Calculate the ratio of listeners to showtime
        shows[ index ].overall.ratio = shows[ index ].overall.showtime > 0 ? shows[ index ].overall.listeners / shows[ index ].overall.showtime : 0
        shows[ index ].semester.ratio = shows[ index ].semester.showtime > 0 ? shows[ index ].semester.listeners / shows[ index ].semester.showtime : 0
        shows[ index ].week.ratio = shows[ index ].week.showtime > 0 ? shows[ index ].week.listeners / shows[ index ].week.showtime : 0
        shows[ index ].range.ratio = shows[ index ].range.showtime > 0 ? shows[ index ].range.listeners / shows[ index ].range.showtime : 0

        // Calculate the reputation percent
        shows[ index ].overall.reputationScore += shows[ index ].overall.reputationScoreMax;
        shows[ index ].overall.reputationPercent = shows[ index ].overall.reputationScore > 0 ? Math.round(100 * (shows[ index ].overall.reputationScore / shows[ index ].overall.reputationScoreMax)) : 0;
        shows[ index ].semester.reputationScore += shows[ index ].semester.reputationScoreMax;
        shows[ index ].semester.reputationPercent = shows[ index ].semester.reputationScore > 0 ? Math.round(100 * (shows[ index ].semester.reputationScore / shows[ index ].semester.reputationScoreMax)) : 0;
        shows[ index ].week.reputationScore += shows[ index ].week.reputationScoreMax;
        shows[ index ].week.reputationPercent = shows[ index ].week.reputationScore > 0 ? Math.round(100 * (shows[ index ].week.reputationScore / shows[ index ].week.reputationScoreMax)) : 0;
        shows[ index ].range.reputationScore += shows[ index ].range.reputationScoreMax;
        shows[ index ].range.reputationPercent = shows[ index ].range.reputationScore > 0 ? Math.round(100 * (shows[ index ].range.reputationScore / shows[ index ].range.reputationScoreMax)) : 0;
