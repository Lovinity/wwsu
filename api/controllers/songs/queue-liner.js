module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      if (this.req.payload.lockToDJ !== null && this.req.payload.lockToDJ !== sails.models.meta.memory.dj) { return exits.error(new Error('You are not authorized to queue a sports liner because you are not on the air.')) }
