module.exports = {
  ...
  fn: async function (inputs, exits) {
    try {
      ...
      // Add test alerts
      var value = DateTime.local().valueOf()
      await sails.helpers.eas.addAlert(value, 'WWSU', 'Clark', 'Test', 'Severe', DateTime.local().toISO(), DateTime.local().plus({minutes: 3}).toISO(), '#FFFFFF', 'This is a test of the WWSU Emergency Alert System. This is only a test. The WWSU Emergency Alert System is designed to provide the public with timely emergency information, as well as weather alerts for Clark, Greene, and Montgomery counties of Ohio. Had this been an actual emergency, you would have received information and instructions regarding the emergency. This concludes the test of the WWSU Emergency Alert System.')
      await sails.helpers.eas.addAlert(value, 'WWSU', 'Greene', 'Test', 'Severe', DateTime.local().toISO(), DateTime.local().plus({minutes: 3}).toISO(), '#FFFFFF', 'This is a test of the WWSU Emergency Alert System. This is only a test. The WWSU Emergency Alert System is designed to provide the public with timely emergency information, as well as weather alerts for Clark, Greene, and Montgomery counties of Ohio. Had this been an actual emergency, you would have received information and instructions regarding the emergency. This concludes the test of the WWSU Emergency Alert System.')
      await sails.helpers.eas.addAlert(value, 'WWSU', 'Montgomery', 'Test', 'Severe', DateTime.local().toISO(), DateTime.local().plus({minutes: 3}).toISO(), '#FFFFFF', 'This is a test of the WWSU Emergency Alert System. This is only a test. The WWSU Emergency Alert System is designed to provide the public with timely emergency information, as well as weather alerts for Clark, Greene, and Montgomery counties of Ohio. Had this been an actual emergency, you would have received information and instructions regarding the emergency. This concludes the test of the WWSU Emergency Alert System.')
