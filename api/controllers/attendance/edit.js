module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      if (typeof inputs.happened !== 'undefined' && inputs.happened !== null) { criteria.happened = inputs.happened }

      if (typeof inputs.ignore !== 'undefined' && inputs.ignore !== null) { criteria.ignore = inputs.ignore }

      // We must clone the InitialValues object due to how Sails.js manipulates any objects passed as InitialValues.
      var criteriaB = _.cloneDeep(criteria)

      // Edit it
      await sails.models.attendance.update({ ID: inputs.ID }, criteriaB).fetch()
