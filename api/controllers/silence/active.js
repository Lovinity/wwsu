module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      if (sails.models.status.errorCheck.prevSilence && moment().isBefore(moment(sails.models.status.errorCheck.prevSilence).add(3, 'minutes')) && (sails.models.meta.memory.state.startsWith('automation_') || sails.models.meta.memory.state.startsWith('prerecord_'))) {
      ...
      if (sails.models.status.errorCheck.prevSilence && moment().isBefore(moment(sails.models.status.errorCheck.prevSilence).add(2, 'minutes')) && !sails.models.meta.memory.state.startsWith('automation_') && !sails.models.meta.memory.state.startsWith('prerecord_')) {
