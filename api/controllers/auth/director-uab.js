...
module.exports = {
    ...
    fn: async function (inputs, exits) {
        ...
        try {
            ...
            var director = await sails.models.uabdirectors.findOne({name: inputs.username});
            if (!director)
                return exits.noToken({tokenErr: "The provided director either does not exist or is not authorized."});
