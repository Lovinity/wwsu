...
module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      var host = await sails.models.hosts.findOrCreate({ host: inputs.username }, { host: inputs.username, friendlyname: inputs.username })
      ...
      var token = jwt.sign({ host: host.host, admin: host.admin, lockToDJ: host.lockToDJ, exp: Math.floor(Date.now() / 1000) + (60 * 10) }, sails.config.custom.secrets.host, { subject: 'host' })
