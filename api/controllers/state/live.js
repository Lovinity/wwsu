  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      if (!sails.models.meta.memory.state.startsWith('live_')) {
        ...
        await sails.helpers.meta.change.with({ queueFinish: moment().add(queueLength, 'seconds').toISOString(true), state: 'automation_live', show: inputs.showname, topic: inputs.topic, trackStamp: null, webchat: inputs.webchat })
      } else {
