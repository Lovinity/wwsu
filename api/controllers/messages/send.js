...
module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    try {
      ...
      if (inputs.to.startsWith('display-') && this.req.payload.lockToDJ !== null && this.req.payload.lockToDJ !== sails.models.meta.memory.dj) { return exits.error(new Error('You are not authorized to send a message to the display signs because you are not on the air.')) }
