...
module.exports = {
    ...
    friendlyName: 'Calendar / Verify-data',

    description: 'Get the data necessary for use in the calendar/verify page.',
    ...
    fn: async function (inputs, exits) {
        sails.log.debug('Controller calendar/verify-data called.');
        ...
        try {
            ...
            await sails.helpers.asyncForEach(calendar, function (event, index) {
                return new Promise(async (resolve, reject) => {
                    try {
                        retData[index] = {start: event.start, end: event.end};
                        var type = 'Manual';
