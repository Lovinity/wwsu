  ...
  template: [
    {
      ...
      status: 4,
      data:
        "Successful database test has not been run yet since initialization. This test is run every minute.",
      time: null
    },
    {
      name: "db-radiodj",
    ...
    },
    {
      ...
      label: "Website",
      data:
        "No connection to wwsu1069.org could be made yet since initialization. This test is run every minute.",
      status: 4,
      time: null
    },
    {
      ...
      label: "Radio Stream",
      data:
        "Public radio stream has not reported online since initialization. This test is run every minute.",
      status: 4,
      time: null
    },
    {
      ...
      label: "Silence",
      data:
        "The silence detection system has not reported silence since initialization.",
      status: 5,
      time: null
    },
    {
      ...
      label: "EAS NWS CAPS",
      data:
        "No successful connection to all EAS NWS CAPS has been made yet since initialization. EAS CAPS is queried every minute.",
      status: 4,
      time: null
    },
    {
      ...
      label: "Server",
      data:
        "No server data has been returned yet since initialization. Server data is checked every minute.",
      status: 4,
      time: null
    },
    {
      ...
      label: "Music Library",
      data:
        "Music library tests have not yet executed since initialization. They are executed every 5 minutes.",
      status: 4,
      time: null
    },
    {
      ...
      label: "Calendar",
      data:
        "Calendar has not been loaded since initialization. Calendar checks are run every 5 minutes.",
      status: 4,
      time: null
    },
    {
      ...
      label: "Underwritings",
      data:
        "Underwritings were not yet checked since initialization. Underwritings are checked at every clockwheel break.",
      status: 4,
      time: null
    },
    /*
    ...
    */
    ...
    },
    {
      ...
      status: 4,
      data:
        "System has not yet checked reported problems since initialization.",
      time: null
    },
    {
      name: "inventory",
              ...
              .map(async instance => {
                ...
                if (status && status.status !== 1) {
                  await sails.helpers.status.change.with({
                    ...
                    status: 2,
                    data: `RadioDJ triggered queueFail for failing to report queue data. Please ensure this RadioDJ is not frozen and the REST server is online, configured correctly, and accessible on the network. You might have to play a track after opening RadioDJ before REST begins to work.`
                  });
                }
                return true;
              });
                ...
                .map(async instance => {
                  ...
                  if (status && status.status !== 1) {
                    await sails.helpers.status.change.with({
                      ...
                      label: `RadioDJ ${instance.label}`,
                      status: 2,
                      data: `RadioDJ triggered queueFrozen multiple times; it has probably crashed. Please ensure this RadioDJ is not frozen and the REST server is online, configured correctly, and accessible on the network. You might have to play a track after opening RadioDJ before REST begins to work.`
                    });
                  }
                  return true;
                });
