...
module.exports = {
    ...
    errorCheck: {
        ...
        // Triggered if the total queue length when preparing to go live is greater than config.custom.queueCorrection.live; tries to speed up the going live process
        liveQueue: {
            count: 0,
            trigger: 4, // Trigger the check in 4 seconds to give time for RadioDJ to settle down with track queueing / removing
            active: false,
            fn: function () {
                return new Promise(async (resolve, reject) => {
                    try {
        ...
        // Triggered if the amount of time between now and the first playlist track is greater than config.custom.queueCorrection.prerecord; tries to speed up the process of starting a prerecord
        prerecordQueue: {
            count: 0,
            trigger: 4, // Trigger the check in 4 seconds to give time for RadioDJ to settle down with track queueing / removing
            active: false,
        ...
        // Triggered if the total queue length when preparing to start a sports broadcast is greater than config.custom.queueCorrection.sports; tries to speed up the going sports process
        sportsQueue: {
            count: 0,
            trigger: 4, // Trigger the check in 4 seconds to give time for RadioDJ to settle down with track queueing / removing
            active: false,
        ...
        // Triggered if the total queue length when returning from a sports break is greater than config.custom.queueCorrection.sportsReturn; tries to speed up returning to sports.
        sportsReturnQueue: {
            count: 0,
            trigger: 4, // Trigger the check in 4 seconds to give time for RadioDJ to settle down with track queueing / removing
            active: false,
        ...
        // Triggered if the total queue length when preparing to start a remote broadcast is greater than config.custom.queueCorrection.remote; tries to speed up the going remote process
        remoteQueue: {
            count: 0,
            trigger: 4, // Trigger the check in 4 seconds to give time for RadioDJ to settle down with track queueing / removing
            active: false,
