...
module.exports.policies = {
  ...
  'inventory/add': ['isBanned', 'isSocket', 'isAuthorizedDirector'],
  'inventory/edit': ['isBanned', 'isSocket', 'isAuthorizedDirector'],
  'inventory/edit-checkout': ['isBanned', 'isSocket', 'isAuthorizedDirector'],
  'inventory/remove': ['isBanned', 'isSocket', 'isAuthorizedDirector'],
  'inventory/remove-checkout': ['isBanned', 'isSocket', 'isAuthorizedDirector'],
  listen: true,
  'listen/*': true,
